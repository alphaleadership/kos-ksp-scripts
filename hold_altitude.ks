...
GLOBAL steer_cmd IS HEADING(target_heading, 0, 0).
...
UNTIL FALSE {
    ...
    SET steer_cmd TO HEADING(target_heading, pitch_cmd, 0).
    ...
    SET throttle_cmd TO MIN(1.0, MAX(0.05, 0.5 + (speed_error / 40))).
