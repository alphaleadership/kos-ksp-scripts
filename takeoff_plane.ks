...
UNTIL runmode = 5 {
    ...
    if runmode = 1 {
        ...
        // Alignement strict sur l'axe de piste du KSC (90°) au sol
    ...
    IF runmode = 2 {
        ...
        // Cabrer à 12 degrés sur le cap de piste
        LOCK STEERING TO HEADING(runway_heading, 12, 0).
    ...
    IF runmode = 3 {
        ...
        // Virage progressif vers la direction de l'île (target_island:BEARING) tout en montant (15°)
        LOCK STEERING TO HEADING(target_island:BEARING, 15, 0).
    ...
    IF runmode = 4 {
        ...
        // Mode croisière actif indéfiniment pendant le trajet
        WAIT 0.2.
    }
}
